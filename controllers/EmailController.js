...
const enviarNovoPedido = ({ usuario, pedido }) => {
    const message = `
        ...
        <br /><br />
        <p>Atenciosamente,</p>
        <p>Equipe - Sams Papelaria</p>
    `;
    _send({
        subject: "Pedido Recebido - Sams Papelaria",
...
const cancelarPedido = ({ usuario, pedido }) => {
    ...
    `;
    _send({
        subject: "Pedido Cancelado - Sams Papelaria",
        emails: usuario.email,
        message
    });
}
...
const atualizarPedido = ({ usuario, pedido, status, data, tipo }) => {
    ...
    `;
    _send({
        subject: "Pedido Atualizado - Sams Papelaria",
        emails: usuario.email,
        message
    });
}
